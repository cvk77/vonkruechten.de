...
atoms.add("Anchor", () => (
  <Anchor href={text("Href", "#")}>{text("Label", "Link")}</Anchor>
));
...
atoms.add("Section", () => (
  <Section>
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum, magni minus
    dolorum dolorem aut dolor at itaque deleniti totam inventore iusto corporis
    veniam in consequuntur dignissimos nisi labore culpa ducimus!
  </Section>
));
...
molecules.add("ContentBlock", () => (
  <ContentBlock id={text("Id", "my-id")} title={text("Title", "Content block")}>
    <p>
      ...
      ipsam dolorem. Magnam voluptatum nulla iure tenetur in culpa. Eos
      accusamus doloremque sunt sequi a blanditiis eius unde eaque ex nesciunt?
    </p>
  </ContentBlock>
));
